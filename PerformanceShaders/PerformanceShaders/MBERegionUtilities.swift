...
func MBEOriginEqualToOrigin(a: MTLOrigin, _ b: MTLOrigin) -> Bool {
    return a.x == b.x && a.y == b.y && a.z == b.z
}

func MBESizeEqualToSize(a: MTLSize, _ b: MTLSize) -> Bool {
    return a.width == b.width && a.height == b.height && a.depth == b.depth
}

/// Returns true iff two regions compare as member-wise equal
public func MBERegionEqualToRegion(a: MTLRegion, b: MTLRegion) -> Bool {
...
public func MBERegionClippedToSize(region: MTLRegion, size: MTLSize) -> MTLRegion {
