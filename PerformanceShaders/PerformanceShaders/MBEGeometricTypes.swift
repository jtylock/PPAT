...
func matrix_translation(translation: float3) -> float4x4
{
    var mat = float4x4()
...
func matrix_rotation_about_axis(axis: float4, byAngleRadians angle: Float32) -> float4x4
{
    var mat = float4x4()
...
func matrix_perspective_projection(aspect: Float32, fieldOfViewYRadians fovy: Float32, near: Float32, far: Float32) -> float4x4
{
    var mat = float4x4()
